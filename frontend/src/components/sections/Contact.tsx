...
const CONTACT_INFO = [
  {
    label: 'Email',
    value: 'alokhotta10@gmail.com',
    href: 'mailto:alokhotta10@gmail.com',
    Icon: Mail,
    copyable: true,
  },
  {
    label: 'GitHub',
    value: 'github.com/iamalok123',
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/alok-hotta',
    href: 'https://www.linkedin.com/in/alok-hotta',
    Icon: Linkedin,
    copyable: false,
  },
]
